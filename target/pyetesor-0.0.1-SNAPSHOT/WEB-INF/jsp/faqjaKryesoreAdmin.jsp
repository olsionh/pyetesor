...
<header class="header-user-dropdown">
    <div class="header-limiter">
        ...
        <nav>
            ...
            <a href="http://localhost:8080/pyetesor/user/seminaret">Shiko kurset</a>
        ...
        <div class="container-fluid gedf-wrapper">
            <div class="row">
                        ...
                        <ul class="list-group">
                            <c:forEach var="kategori" items="${kategoria}">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="http://localhost:8080/pyetesor/user/category/${kategori.categoryId}">${kategori.categoryName}</a>
                                </li>
                            </c:forEach>
                        </ul>
                        <br><br>
                        ...
                        <ul class="list-group">
                            <c:forEach var="testi" items="${testet}">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge badge-primary badge-pill">${testi.categoryName}</span>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
                ...
                <div class="col-md-6 gedf-main">
                    ...
                    <div style="width: 120%; margin-left: -10%" ng-repeat="x in posts | orderBy: '-postimi.dateCreated'" class="card gedf-card">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="ml-2">
                                        ...
                                        <div class="h7 text-muted">{{x.postimi.pedagogu}}</div>
                                    </div>
                                </div>
                                <div>
                                    <div class="dropdown">
                        ...
                        <div style="position:relative" class="card-footer" ng-repeat="y in x.koments | orderBy: 'komentId'">
                            <span ng-if="y.username != 'admin'"><span class="text-primary">{{y.emri}} {{y.mbiemri}}</span> {{y.koment}}</span>
                            <span ng-if="y.username === 'admin'"><span class="text-success">{{x.postimi.pedagogu}}</span> {{y.koment}}</span>
