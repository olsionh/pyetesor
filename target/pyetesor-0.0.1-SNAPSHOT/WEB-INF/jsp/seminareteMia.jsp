                            ...
                            <section class="container">
                                <div class="row">
                                    <div class="container" ng-app="afishoSeminar" >
                                        <div ng-controller="afishTegjithSeminaret" ng-init="initSeminar()">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody ng-repeat="x in seminars">

                                            <tr>
                                            <td id="seminar" class="table-success">{{x.seminar}}</td>
                                            <td id="pedagogu" class="table-success">{{x.pedagogu}}</td>
                                            <td id="sesioni" class="table-success">{{x.sesioni}}</td>
                                            <td class="table-success"><button ng-click="cregjistrohu(x.seminarId)" class="btn btn-danger">Cregjistrohu</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
