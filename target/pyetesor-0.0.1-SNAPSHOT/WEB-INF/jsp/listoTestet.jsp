        ...
        <div class="container-fluid gedf-wrapper">
            <div class="row">
                ...
                <div class="col-md-6 gedf-main">
                    ...
                    <!--- \\\\\\\Post-->
                    <h4>Lista e testeve qe bejne pjese ne kete kurs</h4>
                    <ul class="list-group">
                        <c:forEach var="x" items="${test}">
                            <spring:url value="/user/test/${x.testId}" var="testlink"></spring:url>
                            <li class="list-group-item"><a href="${testlink}">${x.testName}</a></li>
                        </c:forEach>
                    </ul>
