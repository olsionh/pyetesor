...
<%
    ...
    try {
        List<Map<String, ?>> dataSource = (List<Map<String, ?>>) request.getAttribute("listMesataret");
        JRDataSource jrDataSource = new JRBeanCollectionDataSource(dataSource);
        String jrxmlFile = session.getServletContext().getRealPath("classpath: /reports/seminaret.jrxml");
        InputStream input = new FileInputStream(new File("C:\\Users\\olsio\\OneDrive - Fakulteti i Teknologjise se Informacionit\\Diploma\\pyetesor\\src\\main\\resources\\reports\\mesataret.jrxml"));
