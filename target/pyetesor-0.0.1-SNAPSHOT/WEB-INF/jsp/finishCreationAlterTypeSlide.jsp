...
<div  style="margin-left:110px;width:84%">
    <div class="panel panel-default">
        ...
        <br/><br/>
        <form:form method="POST" id="saveAlternativs"  class="form-horizontal"  ng-app="newAlternative" ng-controller="addAlternative" >
            ...
            <div class="form-group" style="width:90%;margin-left:70px">
                <div class="col-sm-5" >
                    <input type="number"   ng-model="fillim.alternativ" class="form-control"  placeholder="Vlera fillestare"  >
                    <input type="number"   ng-model="fund.alternativ" class="form-control"  placeholder="Vlera perfundimtare"  >
                    <input type="number" id="esakta" name="esakta"  ng-model="mes.alternativ" class="form-control"  placeholder="Vlera e sakte"  >

                </div>
            </div>
            <div class="form-group">
                <div style="margin-right:70px;float:right">
                    <input type="submit" style="margin-top:-50px;margin-left:970px;" ng-click="shtoAlternativSlide()" class="btn btn-success"  value="Ruaj pergjigjen"/>
                </div>
            </div>
